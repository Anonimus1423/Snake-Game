...
class Snake
{
	...
	start()
	{
		document.body.addEventListener("keydown", () => this.changeDirection(event))
	...
	{
		this.score++;
		document.getElementById("score").innerHTML = "Youre Score: " + this.score;
		this.applex = (Math.random() * (canvas.width - this.width));
		this.appley = (Math.random() * (canvas.height - this.height));
	}
...
let snake = new Snake(20, 20, 330, "#F6C90E");
snake.start();